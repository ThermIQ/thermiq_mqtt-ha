...
reg_id = {
    ...
    'time': ['time', 'generated_sensor', 's', 0, 50, 0, 0],
...
id_names = {
    ...
    'brine_temperature_alm': [
        ...
        'Larm lågtemp. brine',
        'Hälytys matalalämpötila keruuliuos',
        'Alarmlavtemp. brine',
    ...
    'brine_min_t': [
        ...
        'Keruulämpötila, alin raja (-15 pois)',
    ...
    'room_sensor_set_t': [
        'Room sensor, Set target',
        'Rums sensor, Styrvärde',
        'Room sensor, Set target',
        'Room sensor, Set target',
        'Room sensor, Set target',
    ],
