...
#  reg_id          : ['reg#', 'type', 'unit', 'bitmask or min', 'max', 'panel', panel_order' ],
  ...
  'integral1_a_limit'            : ['r1a', 'sensor',                 '',                  '',      '',  0,  0  ],
  ...
  'integral1_curve_p5'           : ['r37', 'temperature_input',      'ºC',               0,    200,  4,  4  ],
  'integral1_curve_0'            : ['r38', 'temperature_input',      'ºC',               0,    200,  4,  5  ],
  ...
  'elect_boiler_steps_max'       : ['r51', 'sensor_input',           'steps',        -32768,  32767,  9,  2  ],
  'current_consumption_max_a'    : ['r52', 'sensor_input',           'A',            -32768,  32767,  9,  3  ],
  ...
  'outdoor_sensor_offset_t'      : ['r5b', 'temperature_input',      'ºC',               0,    100, 10,  4  ],
  'supplyline_sensor_offset_t'   : ['r5c', 'temperature_input',      'ºC',               0,    100, 10,  5  ],
  'returnline_sensor_offset_t'   : ['r5d', 'temperature_input',      'ºC',               0,    100, 10,  6  ],
  'boiler_sensor_offset_t'       : ['r5e', 'temperature_input',      'ºC',               0,    100, 10,  7  ],
  'brine_in_sensor_offset_t'     : ['r5f', 'temperature_input',      'ºC',               0,    100, 10,  8  ],
  'brine_out_sensor_offset_t'    : ['r60', 'temperature_input',      'ºC',               0,    100, 10,  9  ],
  ...
  'legionella_run_on'            : ['r66', 'sensor_input',           '',             -32768,  32767, 10, 14  ],
